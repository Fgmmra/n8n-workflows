...
|---------|-----------|------|
| `Atualização Dashboard financeiro.json` | Workflow n8n — importar diretamente | [📄 Ver arquivo](https://github.com/Fgmmra/n8n-workflows/edit/main/domains/finance/DRE-dashboard/Atualização-Dashboard-financeiro.json) |
| `script Planilha.js` | Macro Google Apps Script — colar no GAS | [📄 Ver arquivo](https://github.com/Fgmmra/n8n-workflows/edit/main/domains/finance/DRE-dashboard/script-Planilha.js) |
| `index.html` | Dashboard HTML — abrir no navegador | [📄 Ver arquivo](https://github.com/Fgmmra/n8n-workflows/edit/main/domains/finance/DRE-dashboard/index.html) |
