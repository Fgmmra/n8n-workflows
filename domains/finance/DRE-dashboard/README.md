...
|---------|-----------|------|
| `Atualização Dashboard financeiro.json` | Workflow n8n — importar diretamente | [📄 Ver arquivo](./Atualização-Dashboard-financeiro.json) |
| `script Planilha.js` | Macro Google Apps Script — colar no GAS | [📄 Ver arquivo](./script-Planilha.js) |
| `index.html` | Dashboard HTML — abrir no navegador | [📄 Ver arquivo](./index.html) |
